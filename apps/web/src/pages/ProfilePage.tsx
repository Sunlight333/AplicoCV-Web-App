...
const PROFILE_COPY: Record<Locale, ProfileExtraCopy> = {
  en: {
    ...
    analysisTitle: 'Personal analysis', analysisSub: 'Your strengths, a growth area, and what drives you.', analyzeBtn: 'Analyze me',
    strengths: 'Strengths', growthArea: 'Growth area', motivation: 'Motivation',
    skillsTitle: 'Skill suggestions', skillsSub: 'Relevant skills to add to your profile.', suggestBtn: 'Suggest skills',
  ...
  es: {
    ...
    analysisTitle: 'Análisis personal', analysisSub: 'Tus fortalezas, un área de mejora y lo que te motiva.', analyzeBtn: 'Analízame',
    strengths: 'Fortalezas', growthArea: 'Área de mejora', motivation: 'Motivación',
    skillsTitle: 'Sugerencias de habilidades', skillsSub: 'Habilidades relevantes para agregar a tu perfil.', suggestBtn: 'Sugerir habilidades',
  ...
  'pt-BR': {
    ...
    analysisTitle: 'Análise pessoal', analysisSub: 'Seus pontos fortes, um ponto a desenvolver e o que te motiva.', analyzeBtn: 'Analise-me',
    strengths: 'Pontos fortes', growthArea: 'Ponto a desenvolver', motivation: 'Motivação',
    skillsTitle: 'Sugestões de habilidades', skillsSub: 'Habilidades relevantes para adicionar ao seu perfil.', suggestBtn: 'Sugerir habilidades',
