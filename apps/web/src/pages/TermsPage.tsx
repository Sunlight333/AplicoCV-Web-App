...
const COPY: Record<Locale, TermsCopy> = {
  en: {
    ...
    sections: [
      ...
      { title: 'Plans & billing', paras: ['Some features require a paid plan. Paid plans are billed on a recurring basis and may be cancelled at any time; cancellation stops future renewals. Prices and features may change with notice.'] },
  ...
  es: {
    ...
    sections: [
      ...
      { title: 'Planes y facturación', paras: ['Algunas funciones requieren un plan de pago. Los planes de pago se facturan de forma recurrente y pueden cancelarse en cualquier momento; la cancelación detiene las renovaciones futuras. Los precios y funciones pueden cambiar con previo aviso.'] },
  ...
  'pt-BR': {
    ...
    sections: [
      ...
      { title: 'Planos e faturamento', paras: ['Alguns recursos exigem um plano pago. Os planos pagos são cobrados de forma recorrente e podem ser cancelados a qualquer momento; o cancelamento interrompe as renovações futuras. Preços e recursos podem mudar mediante aviso.'] },
