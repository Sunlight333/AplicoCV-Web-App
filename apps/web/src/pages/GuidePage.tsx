...
const STEPS: Record<Locale, Step[]> = {
  en: [
    ...
    { title: 'Complete your profile', body: 'Add experience, skills and a few common answers. A complete profile makes every AI tool sharper and lets the autofill do more for you.', to: '/profile', cta: 'Go to profile' },
    { title: 'Optimize your CV for a role', body: 'Use the optimized CV to rewrite your experience with the X-Y-Z formula and an ATS score, or generate a 100% personalized cover letter.', to: '/optimize', cta: 'Optimize CV' },
  ...
  es: [
    ...
    { title: 'Completa tu perfil', body: 'Agrega experiencia, habilidades y algunas respuestas comunes. Un perfil completo hace que cada herramienta de IA sea más precisa y permite que el autocompletado haga más por ti.', to: '/profile', cta: 'Ir al perfil' },
    { title: 'Optimiza tu CV para un puesto', body: 'Usa el CV optimizado para reescribir tu experiencia con la fórmula X-Y-Z y un puntaje ATS, o genera una carta de presentación 100% personalizada.', to: '/optimize', cta: 'Optimizar CV' },
  ...
  'pt-BR': [
    ...
    { title: 'Complete seu perfil', body: 'Adicione experiência, habilidades e algumas respostas comuns. Um perfil completo deixa cada ferramenta de IA mais precisa e permite que o preenchimento automático faça mais por você.', to: '/profile', cta: 'Ir para o perfil' },
    { title: 'Otimize seu currículo para uma vaga', body: 'Use o currículo otimizado para reescrever sua experiência com a fórmula X-Y-Z e uma pontuação ATS, ou gere uma carta de apresentação 100% personalizada.', to: '/optimize', cta: 'Otimizar currículo' },
