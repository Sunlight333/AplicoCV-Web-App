...
export function GoogleButton({ label }: { label: string }) {
  return (
    <button
      ...
      className="flex h-11 w-full items-center justify-center gap-3 rounded-lg border border-navy-200 bg-white text-sm font-semibold text-navy-700 transition-colors hover:bg-navy-50"
    >
